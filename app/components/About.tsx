...
export default function About() {
  ...
  const profileImageUrl =
    "./link.JPG" // Replace with your actual image URL
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-2/3 md:pl-12">
            ...
            <p className="text-xl mb-6">
              I'm a dedicated and curious software engineer with a strong foundation in programming, React, and DJango.
            </p>
            <p className="text-xl mb-8">
            I have experience working across various domains, including Frontend, Backend(python & sql), and web development.
            Well-versed in Python, Javascript, SQL, and modern development tools and frameworks.
