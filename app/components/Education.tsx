  ...
  const education = [
    {
      ...
      "logo": "clg-logo.jpeg",
      "field": "E.C.E",
      "school": "Sri Sivani College Of Engneering , Srikakulam",
      "year": "2021 - 2025",
      "description": "Graduated a Bachelor of Technology with Honors."
    }
    ,
    {
      "id": 2,
      "degree": "Intermeadiate",
      "logo": "./clg2-logo.jpeg",
      "field": "M.P.C",
      "school": "Gnana Jyothi Junior College,Srikakulam",
      "year": "2019 - 2021",
      "description": "Specialized in Mathematics, Physics, Chemestry"
    },
      ]
